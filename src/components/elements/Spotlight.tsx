...
import MousePosition from '@/lib/hooks/mouse-position'
...
export default function Spotlight({
    ...
    }, [mousePosition.x, mousePosition.y, boxes]) // Added boxes dependency

    // Get child elements on mount
    useEffect(() => {
        if (containerRef.current) {
    ...
    }, [initContainer]) // Corrected dependency
