...
import { getCatByName, incrementCatViews } from "@/lib/firebase/catService"
    ...
    useEffect(() => {
        const fetchCat = async () => {
            try {
                ...
                // Get cat by name from Firebase
                const catData = await getCatByName(decodedName)
                ...
                if (!catData) {
                    ...
                    if (catData.id) {
                        incrementCatViews(catData.id).catch(console.error)
                    }
                }
            } catch (err) {
