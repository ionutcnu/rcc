...
export default function RegisterPage() {
    ...
    useEffect(() => {
        // Set a short timeout to show the loading state briefly before redirecting
        const timer = setTimeout(() => {
            // Redirect to login page with a message parameter
            router.push("/login?message=Registration is currently disabled. Please contact the administrator.")
        }, 1500)
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md bg-white rounded-lg shadow-md p-8 text-center">
                <Loader2 className="h-8 w-8 animate-spin mx-auto text-[#5C6AC4]" />
                <h1 className="mt-4 text-xl font-medium text-[#FF6B6B]">Registration Disabled</h1>
