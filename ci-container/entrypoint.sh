...
vercel deploy --prebuilt --token="$VERCEL_TOKEN" -m githubDeployment=1 -m githubCommitMessage="$COMMIT_INFO_MESSAGE" -m githubCommitSha="$COMMIT_INFO_SHA" -m githubCommitRef="$COMMIT_INFO_BRANCH"
