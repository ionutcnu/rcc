...
export default function CatProfile() {
    ...
    const [isTreeOpen, setIsTreeOpen] = useState(false);  // State to manage genealogical tree modal visibility
    ...
    // Toggle genealogical tree modal
    const toggleTree = () => {
    ...
    return (
        <>
                ...
                <div className="container mx-auto py-10 px-4 flex flex-col lg:flex-row lg:gap-16 lg:py-16 lg:px-8">
                    <div className="lg:w-1/2 lg:order-2">
                        <div className="text-left mb-6 lg:mb-0">
                            ...
                            {/* Genealogical Tree Icon */}
                            <h3 className="text-lg lg:text-xl font-semibold mb-2">FAMILY TREE:</h3>
                            <button onClick={toggleTree} className="text-blue-500 flex items-center">
            ...
            {/* Genealogical Tree Modal */}
            {isTreeOpen && (
                <div className="fixed inset-0 z-50 bg-black bg-opacity-70 flex items-center justify-center">
                    <div className="relative w-11/12 max-w-lg bg-white rounded-lg p-6">
                        <button onClick={toggleTree} className="absolute top-2 right-2 text-xl">&times;</button>
                        <h2 className="text-2xl font-bold mb-4">Genealogical Tree</h2>

                        {/* Mother's Info */}
                        <div className="mb-4">
                            <h3 className="text-lg font-semibold">Mother: {cat.motherName}</h3>
                            <p className="text-gray-600">Short description about the mother.</p>
                            <Image
                                src="/Cats/Images/mother.jpg"  // Replace with the actual image URL
                                alt="Mother"
                                width={150}
                                height={150}
                        ...
                        {/* Father's Info */}
                        <div className="mb-4">
                            <h3 className="text-lg font-semibold">Father: {cat.fatherName}</h3>
                            <p className="text-gray-600">Short description about the father.</p>
                            <Image
                                src="/Cats/Images/father.jpg"  // Replace with the actual image URL
                                alt="Father"
                                width={150}
                                height={150}
                                className="rounded-lg mt-2"
